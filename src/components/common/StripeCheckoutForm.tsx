...
//   carOwnerId,
//   dailyRate,
//   customerEmail, // Added to pass to confirmPayment
// }: {
//   setError: (message: string) => void;
//   carId: string;
//   startDate: string;
...
//   carOwnerId: string;
//   dailyRate: string;
//   customerEmail: string; // Added to props
// }) => {
//   const stripe = useStripe();
//   const elements = useElements();
//   const router = useRouter();
...
//           payment_method_data: {
//             billing_details: {
//               email: customerEmail, // Pass customerEmail here
//             },
//           },
//         },
//         redirect: 'if_required',
...
//           };
//           const bookingResponse = await AuthService.createBooking(bookingData);
//           console.log('Booking created successfully:', bookingResponse);

//           // Navigate to confirmation page with bookingId
//           router.push(`/bookings/confirmation?bookingId=${bookingResponse.bookingId}`);
//         } catch (bookingError: any) {
//           const errorMsg = `Payment succeeded, but booking creation failed: ${bookingError.message}`;
//           setMessage(errorMsg);
//           setError(errorMsg);
//           setShowErrorModal(true);
//         }
...
//       <form onSubmit={handleSubmit}>
//         <div className="mb-6 text-center">
//           <img src="/logo.png" alt="Your Brand" className="h-12 mx-auto" />
//           <h2 className="text-xl font-semibold text-indigo-700">Secure Payment</h2>
//         </div>
//         <h3 className="text-lg font-semibold text-indigo-700 mb-4">Choose Payment Method</h3>
//         <PaymentElement
...
//               billingDetails: {
//                 name: 'auto',
//                 email: 'never', // Email not collected in PaymentElement
//               },
//             },
//           }}
//         />
...
//     initPayment();
//   }, [carId, startDate, endDate, totalPrice, customerEmail]);
...
//         carOwnerId={carOwnerId}
//         dailyRate={dailyRate}
//         customerEmail={customerEmail} // Pass customerEmail to CheckoutForm
//       />
//     </Elements>
//   );
// };
