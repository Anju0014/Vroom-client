...
//     try {
//       await signIn("google", {
//         callbackUrl: formData.role === "customer" ? "/" : "/carOwner/home",
//         redirect: false,
//       });
//     } catch (error) {
//       console.error("Google Login Failed:", error);
...
//       console.log("Google session data:", session.user);
  
//       const storedRole = sessionStorage.getItem("googleLoginRole") || "customer";
//       const { setAuth } = useAuthStore.getState();
//       const { setAuthOwner } = useAuthStoreOwner.getState();
...
//         toast.success("Google Login Successful!");
//         router.push(storedRole === "customer" ? "/" : "/carOwner/home");
...
//   }, [session, router, rememberMe, setAuth, setAuthOwner]);
...
//     if (storedRole) {
//       setFormData((prev) => ({ ...prev, role: storedRole as "customer" | "carOwner" }));
//     }
//   }, []);
