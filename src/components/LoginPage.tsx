...
//   // Redirect authenticated users and clean history
//   useEffect(() => {
...
//     }
//   }, [customerUser, customerAccessToken, ownerUser, accessTokenOwner, formData.role, router]);
...
//   if (!hasHydrated) {
//     return <div>Loading...</div>; // A loading indicator while waiting for hydration
//   }
