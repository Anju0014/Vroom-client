...
// //     socket.emit("joinChatRoom", { senderId: currentUserId, receiverId: otherUserId });
...
// //     return () => {
// //     socket.emit("leaveChatRoom", { senderId: currentUserId, receiverId: otherUserId });
...
//     senderId: currentUserId,
//     receiverId: otherUserId, // <-- pass receiverId
//     message: text,
//   });
