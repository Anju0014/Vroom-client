...
// const CarDetailsModal: React.FC<CarDetailsModalProps> = ({ car, onClose,onToggleBlock }) => {
...
//        // Inside your CarDetailsModal component, add this button:

// <button
//   onClick={() => onToggleBlock(car)}
...
//     </div>
//   ) : (
//     car.blockStatus === 0 ? "Block Car" : "Unblock Car"
//   )}
// </button>
